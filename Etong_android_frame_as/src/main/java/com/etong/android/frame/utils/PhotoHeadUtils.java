...
/**
 * @author : zhouxiqing
 * @ClassName : PhotoHeadUtils
 * @Description : TODO(照片工具类,返回图片路径,在裁剪模式下会返回裁剪后得到的BitMap对象)
 * @date : 2015-11-17 上午10:36:00
 */
public class PhotoHeadUtils extends BaseSubscriberActivity {
    public static final String TAG = "PhotoHeadUtils";
    ...
    public static void startPhotoUtils(Context context, String tag,
                                       Boolean share) {
        Intent intent = new Intent(context, PhotoHeadUtils.class);
        ...
        if (view.getId() == R.id.btn_take_photo) {// 拍照
            ...
            PermissionsManager
                    ...
                    .requestPermissionsIfNecessaryForResult(
                            this,
                            new String[]{Manifest.permission.WRITE_EXTERNAL_STORAGE,Manifest.permission.CAMERA},//Android 6.0需要加的权限
