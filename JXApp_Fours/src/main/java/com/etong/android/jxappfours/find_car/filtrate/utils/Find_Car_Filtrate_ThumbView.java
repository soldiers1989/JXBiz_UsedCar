 ...
 */
public class Find_Car_Filtrate_ThumbView extends ImageView implements GestureDetector.OnGestureListener{

    private Find_Car_Filtrate_RangeSeekBar rangeSeekBar;
    ...
    public Find_Car_Filtrate_ThumbView(Context context) {
        this(context, null);
        this.mContext = context;
    }

    public Find_Car_Filtrate_ThumbView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
        this.mContext = context;
    }

    public Find_Car_Filtrate_ThumbView(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        this.mContext = context;
    }

    public void setRangeSeekBar(Find_Car_Filtrate_RangeSeekBar rangeSeekBar) {
