 ...
 * @version 0.4 15-5-13
 */
public abstract class FC_CarconfigChoiceListAdapter<T> extends BaseAdapter {
     ...
     */
    public FC_CarconfigChoiceListAdapter(Context context, int layoutId, List<T> data, int... choiceId) {
        mContext = context;
        mData = data;
        mLayoutId = layoutId;
        mChoiceId = choiceId;
     ...
     */
    public FC_CarconfigChoiceListAdapter(Context context, int layoutId, T[] data, int... choiceId) {
