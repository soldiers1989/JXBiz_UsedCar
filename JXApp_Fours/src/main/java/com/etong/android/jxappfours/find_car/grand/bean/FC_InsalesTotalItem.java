 ...
 */
public class FC_InsalesTotalItem {
    ...
    private int menuId;
    private List<FC_InsalesListItem> carsetList;
    ...
    public List<FC_InsalesListItem> getCarsetList() {
        return carsetList;
    }

    public void setCarsetList(List<FC_InsalesListItem> carsetList) {
