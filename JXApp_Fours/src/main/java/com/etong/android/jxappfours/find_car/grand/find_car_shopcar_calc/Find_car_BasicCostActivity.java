...
*  
*/ 
public class Find_car_BasicCostActivity extends BaseSubscriberActivity {

	private TitleBar mTitleBar;
	private ListView mListView;
	private ListAdapter<Find_car_BasicCost> adapter;
	...
	private void initView() {
		...
		adapter = new ListAdapter<Find_car_BasicCost>(this,
				R.layout.find_car_list_item_carloan_cost) {

			@Override
			protected void onPaint(View view, Find_car_BasicCost data, int position) {
				// TODO Auto-generated method stub

				TextView mCostName = (TextView) view.findViewById(R.id.tv_cost_name);
				TextView mCostMoney = (TextView) view.findViewById(R.id.tv_cost_money);
	...
	public void getCostInfo() {
		...
		for (Object object : array) {
			...
			for (int i = 0; i < costList.size(); i++) {
				Find_car_BasicCost costData = JSON.toJavaObject(
						costList.getJSONObject(i), Find_car_BasicCost.class);
