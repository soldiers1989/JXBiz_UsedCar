...
import com.etong.android.jxappfours.find_car.grand.listener.OnInitSelectedPosition;
import com.etong.android.jxappfours.find_car.grand.listener.OnTagClickListener;
import com.etong.android.jxappfours.find_car.grand.listener.OnTagSelectListener;
 ...
 */
public class GrandFlowTagLayout extends ViewGroup {

    private static final String TAG = GrandFlowTagLayout.class.getSimpleName();
    ...
    public GrandFlowTagLayout(Context context) {
        super(context);
    }

    public GrandFlowTagLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public GrandFlowTagLayout(Context context, AttributeSet attrs, int defStyleAttr) {
                ...
                public void onClick(View v) {
                    if (mTagCheckMode == FLOW_TAG_CHECKED_NONE) {
                        if (mOnTagClickListener != null) {
                            mOnTagClickListener.onItemClick(GrandFlowTagLayout.this, childView, j);
                        }
                        ...
                        if (mCheckedTagArray.get(j)) {
                            ...
                            if (mOnTagSelectListener != null) {
                                mOnTagSelectListener.onItemSelect(GrandFlowTagLayout.this, new ArrayList<Integer>());
                            }
                            return;
                        }
                        ...
                        if (mOnTagSelectListener != null) {
                            mOnTagSelectListener.onItemSelect(GrandFlowTagLayout.this, Arrays.asList(j));
                        }
                    } else if (mTagCheckMode == FLOW_TAG_CHECKED_MULTI) {
                        if (mCheckedTagArray.get(j)) {
                            mCheckedTagArray.put(j, false);
                        ...
                        if (mOnTagSelectListener != null) {
                            ...
                            mOnTagSelectListener.onItemSelect(GrandFlowTagLayout.this, list);
                        }
                    }
                }
            });
