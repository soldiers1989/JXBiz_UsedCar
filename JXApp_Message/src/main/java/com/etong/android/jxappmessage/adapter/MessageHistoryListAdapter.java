...
public class MessageHistoryListAdapter extends BaseAdapter {
    ...
    public MessageHistoryListAdapter(Context mContext,HistoryCallBack historyCallBack) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            convertView = LayoutInflater.from(mContext).inflate(R.layout.message_history_search_list_item, null);
