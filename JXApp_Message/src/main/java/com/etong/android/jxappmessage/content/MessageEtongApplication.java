...
public class MessageEtongApplication extends BaseApplication {
    protected static final String TAG = "MessageEtongApplication";
    protected static MessageEtongApplication application;
    //	protected UserInfo mUserInfo;
    protected ConfigInfo mConfigInfo;
    //	protected UserProvider mUserProvider;
    protected ImageProvider mImageProvider;

    static public MessageEtongApplication getApplication() {
        return application;
    }
