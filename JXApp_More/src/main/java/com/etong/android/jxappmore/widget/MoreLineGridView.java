 ...
 * 自定义画网格线的GridView
 */
public class MoreLineGridView extends GridView {
    public MoreLineGridView(Context context) {
        super(context);
        // TODO Auto-generated constructor stub
    }

    public MoreLineGridView(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public MoreLineGridView(Context context, AttributeSet attrs, int defStyle) {
