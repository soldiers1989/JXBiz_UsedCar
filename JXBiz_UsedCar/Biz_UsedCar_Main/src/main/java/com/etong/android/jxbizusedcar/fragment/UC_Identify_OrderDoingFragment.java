 ...
 */
public class UC_Identify_OrderDoingFragment extends BaseSubscriberFragment {
    ...
    public static final int tabStatus = 12;
...
*/
     ...
     * @author wukefan
     */
    @Subscriber(tag = tabStatus + "")
    public void updataFrgmentContent(String tag) {
        if (mData.isEmpty()) {
            pageCurrent = 0;
            mUC_Provider.queryIdentified(tabStatus, pageSize, pageCurrent, 0);
        } else {
