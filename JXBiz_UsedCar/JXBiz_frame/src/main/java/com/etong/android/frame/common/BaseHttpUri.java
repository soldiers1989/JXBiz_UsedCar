...
public class BaseHttpUri {
	...
	/** 银联支付接口地址 */
	public static String URI_UNION_PAY = UC_Constant.CURRENT_SERVICE
			+ "/pay/unionpay/wap";
	/** 支付宝支付接口地址 */
	public static String URI_ALIPAY_PAY = UC_Constant.CURRENT_SERVICE
			+ "/alipay/getAlipayInfo";
	/** 支付宝回调确认支付地址*/
	public static String URI_ALIPAY_CONFIRM = UC_Constant.CURRENT_SERVICE
			+ "/alipay/checkSign";
	/** 微信支付接口地址 */
	public static String URI_WECHAT_PAY = UC_Constant.CURRENT_SERVICE
