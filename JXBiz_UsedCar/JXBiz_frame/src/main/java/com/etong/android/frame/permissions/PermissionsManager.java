package com.etong.android.frame.permissions;
    ...
    private synchronized void initializePermissionsMap() {
        ...
        for (Field field : fields) {
            ...
            try {
                ...
                L.e(TAG, "Could not access field" + e);
            }
