 ...
 * 
 */
abstract public class BaseSubscriberActivity extends FragmentActivity {
...
//		DefinedToast.showToast(this,msg,0);
		EtongToast.makeText(this, msg, EtongToast.LENGTH_SHORT).show();
	}
...
//			DefinedToast.showToast(this,msg + ":" + errno,0);
			EtongToast.makeText(this, msg + ":" + errno, EtongToast.LENGTH_SHORT).show();
		} else {
//			CToast.toastMessage(msg, 0);
//			DefinedToast.showToast(this,msg,0);
			EtongToast.makeText(this, msg, EtongToast.LENGTH_SHORT).show();
...
//			DefinedToast.showToast(this,msg + "(" + err + ")",0);
			EtongToast.makeText(this, msg + "(" + err + ")", EtongToast.LENGTH_SHORT).show();
		} else {
//			CToast.toastMessage(msg, 0);
//			DefinedToast.showToast(this,msg,0);
			EtongToast.makeText(this, msg, EtongToast.LENGTH_SHORT).show();
