...
public abstract class BaseSubscriberFragment extends Fragment {
	...
	protected UC_FrameEtongApplication mUCFrameEtongApplication = UC_FrameEtongApplication.getApplication();
	 ...
	 * @return
	 */
	protected UC_FrameEtongApplication getEtongApplication() {
		return mUCFrameEtongApplication;
	}
	/**
	 * @Title : getEventBus
	...
	public void onDestroy() {
		...
		super.onDestroy();
		mLoading.dismiss();
		EtongToast.reset();			// 为了解决Toast的bug
	}
...
//		DefinedToast.showToast(getActivity(),msg,0);
		EtongToast.makeText(getActivity(), msg, EtongToast.LENGTH_SHORT).show();
	}
...
//		DefinedToast.showToast(getActivity(),msg + "：" + errno,0);
//		else
////			CToast.toastMessage(msg, 0);
//			DefinedToast.showToast(getActivity(),msg,0);
		if (BaseApplication.isDebug) {
...
//			DefinedToast.showToast(this,msg + ":" + errno,0);
			EtongToast.makeText(getActivity(), msg + ":" + errno, EtongToast.LENGTH_SHORT).show();
		} else {
//			CToast.toastMessage(msg, 0);
...
//			DefinedToast.showToast(getActivity(),msg + "(" + err + ")",0);
//		else
////			CToast.toastMessage(msg, 0);
//			DefinedToast.showToast(getActivity(),msg,0);
		if (BaseApplication.isDebug) {
...
//			DefinedToast.showToast(this,msg + "(" + err + ")",0);
			EtongToast.makeText(getActivity(), msg + "(" + err + ")", EtongToast.LENGTH_SHORT).show();
		} else {
//			CToast.toastMessage(msg, 0);
//			DefinedToast.showToast(this,msg,0);
			EtongToast.makeText(getActivity(), msg, EtongToast.LENGTH_SHORT).show();
