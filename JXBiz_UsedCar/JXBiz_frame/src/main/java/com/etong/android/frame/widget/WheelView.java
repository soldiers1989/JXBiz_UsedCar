...
//			0x00AAAAAA, 0x00AAAAAA };
	...
	private static int mWheelBackground;
	private static int mWheelCenterDrawable;
	...
	public static void setWheelBackground(int background, int centerDrawable) {
		mWheelBackground = background;
		mWheelCenterDrawable = centerDrawable;
	}
