...
public class UC_CancelConformDialog extends Dialog {
    ...
    public UC_CancelConformDialog(Context context, boolean iscanCancel) {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        this.setContentView(R.layout.uc_dialog_cancel_conform);
        mConfirmButton = (Button) this.findViewById(R.id.uc_cc_btn_sure);
        mCancleButton = (Button) this.findViewById(R.id.uc_cc_btn_cancels);
        mContent = (TextView) this.findViewById(R.id.uc_cc_tv_dialog_cotent);
        mTitle = (TextView) this.findViewById(R.id.uc_cc_tv_dialog_title);
    ...
    public void show() {
        ...
        if (null != title) {
            mTitle.setText(title);
            mTitle.setVisibility(View.VISIBLE);
            mContent.setBackgroundColor(mContext.getResources().getColor(R.color.white));
        }
