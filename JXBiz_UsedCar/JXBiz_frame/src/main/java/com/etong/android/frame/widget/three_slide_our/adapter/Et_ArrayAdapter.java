 ...
 */
public class Et_ArrayAdapter extends BaseAdapter {
    private Context mContext;
    private List<Et_Add_VechileStyle> data;
    private AdapterCallback adapterCallback;
    public Et_ArrayAdapter(){

    }
    public Et_ArrayAdapter(Context context, List<Et_Add_VechileStyle> data) {
    ...
    public interface AdapterCallback {
        public void callBack(int isCheckedNum, Et_Add_VechileStyle add);
    }
